...
let HandVisual = (() => {
    ...
    var HandVisual = _classThis = class extends _classSuper {
        constructor() {
             ...
             */
            this.unitPlaneMesh = requireAsset("../../../Assets/Meshes/PlaneMesh.mesh");
            /** @internal */
            this.tipGlowRenderOrder = 10000;
            /** @internal */
            this.tipGlowWorldScale = 0.3;
            /** @internal */
            this.triggeredLerpDurationSeconds = 0.1;
            /** @internal */
            this.pinchValidLerpDurationSeconds = 0.25;
            /** @internal */
            this.pokeValidLerpDurationSeconds = 0.5;
            /** @internal */
            this.pinchBrightnessMax = 1.0;
            /** @internal */
            this.pinchGlowBrightnessMax = 0.33;
            /** @internal */
            this.pinchTriggeredMult = 1.2;
            /** @internal */
            this.pinchBrightnessMaxStrength = 0.75;
            /** @internal */
            this.pinchExponent = 2.0;
            /** @internal */
            this.pinchExponentTriggered = 2.0;
            /** @internal */
            this.pinchHighlightThresholdFar = 18;
            /** @internal */
            this.pinchHighlightThresholdNear = 4;
            /** @internal */
            this.pokeBrightnessMax = 1.0;
            /** @internal */
            this.pokeGlowBrightnessMax = 0.33;
            /** @internal */
            this.pokeTriggeredMult = 1.4;
            /** @internal */
            this.pokeHighlightThresholdFar = 10;
            /** @internal */
            this.pokeHighlightThresholdNear = 2;
            /** @internal */
            this.pokeOccludeThresholdFar = 8;
            /** @internal */
            this.pokeOccludeThresholdNear = 0;
            /** @internal */
            this.pokeExponent = 3.0;
            /** @internal */
            this.pokeExponentTriggered = 1.0;
