...
class BaseInteractor extends BaseScriptComponent {
    __initialize() {
         ...
         */
        this.spherecastRadii = [0.5, 2.0, 4.0];
        /**
         * @internal
         ...
         */
        this.spherecastDistanceThresholds = [0, 12, 30];
