...
export class CameraCaptureToPlaceholder extends BaseScriptComponent {
  @ui.label(
    '<span style="color: #60A5FA;">Camera Capture → Placeholder</span><br/>' +
      '<span style="color: #94A3B8; font-size: 11px;">Press the RoundButton to freeze the current cropped camera frame onto the placeholder image.</span>'
  )
  @ui.separator
