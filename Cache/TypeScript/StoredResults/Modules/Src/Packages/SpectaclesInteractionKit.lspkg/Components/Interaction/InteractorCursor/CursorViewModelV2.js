...
class CursorViewModel {
    ...
    handleTriggerState(isTriggering, segmentStart, rayDir) {
        ...
        const cursorAlpha = (targetingVisual === Interactable_1.TargetingVisual.Cursor ? 1.0 : 0.0) * fadeMultiplier;
        const rayAlpha = (targetingVisual === Interactable_1.TargetingVisual.Ray ? 1.0 : 0.0) * fadeMultiplier;
    ...
    handleManipulationState(isTriggering) {
        ...
        if (manipulatedPos &&
            ...
            // Apply near-field distance-based fade for cursor and ray
            const fadeMultiplier = this.calculateNearFieldFadeMultiplier();
            const blendFactor = (targetingVisual === Interactable_1.TargetingVisual.Cursor ? 1.0 : 0.0) * fadeMultiplier;
            const rayAlpha = (targetingVisual === Interactable_1.TargetingVisual.Ray ? 1.0 : 0.0) * fadeMultiplier;
    ...
    calculateNearFieldFadeMultiplier() {
        ...
        if (effectiveMode === HandInteractor_1.FieldTargetingMode.Direct || effectiveMode === HandInteractor_1.FieldTargetingMode.BehindNearField) {
            return 0.0;
        }
